...
\begin{proof}
  ...
  that
  \begin{equation*}
    P = Q \cup_D \left\{ FS|_a^d \right\} \andalso FS = \sframe{L, t} \circ GS
  \end{equation*}
  ...
  \begin{description}
    \item[Case $t = x$:] 
      ...
      \begin{equation*}
        \begin{gathered}
          P' = Q \cup_D \left\{ FS'|_a^d \right\} \andalso FS' = \xframe{L'',
          t'}^{s'} \circ HS \\ 
          L'' = L'[s \mapsto L(x)],
        \end{gathered}
      \end{equation*}
    ...
    \item[Case $t = \Let{x}{e}{t'}$:]
      ...
      \begin{description}
        \item[Case $e = \NullVal$:] 
          ...
          \begin{equation*}
            \begin{gathered}
              P' = Q \cup \left\{FS'|_a^d \right\} \andalso FS' = \sframe{L',
              t'} \\
        ...
        \item[Case $e = \Call{y}{m}{z}$:]
          ...
          \begin{equation*}
            \begin{gathered}
              P' = Q \cup \left\{FS'|_a^d \right\} \andalso FS' = \xframe{L'',
              t''}^x \circ \sframe{L, t'} \\
              L_{\text{base}} =
              \begin{cases}
                \emptyset & \text{ if } a = \ocap \\
