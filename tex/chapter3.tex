...
% TODO add section in background about the OCAP model, use the prestudy
% material.
LaCasa\parencite{conf/oopsla/HallerL16} is a programming model for ensuring
determinism in an actor model\parencite{actormodelref} setting. It is based on
the OCAP model to ensure isolation between threads.  In this section we give a
brief introduction to the type system of LaCasa and the intuition behind it.

% TODO explain connection between lacasa and OCAP model
% TODO quickly introduce the type system and explain a little bit why it ensures
% isolation
